...
# build db 
bowtie2-build --threads 25 MN908947_3.fasta sars-cov-2
...
bowtie2 -x sars-cov-2 --threads 20 -1 ${SAMPLE}-R1_paired.fastq.gz -2 ${SAMPLE}-R2_paired.fastq.gz  -S  ${SAMPLE}_mapped_and_unmapped.sam
